...
export const auditEventDetailView = defineCustomView({
  ...
  render: () => (
    <div className="flex flex-col gap-4">
      <PageHeader
        title="ev_42 · booking.confirmed"
        description="Immutable record from the audit chain."
      />
      <div className="grid gap-3 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          ...
          <CardContent>
            <pre className="text-xs font-mono bg-surface-1 border border-border rounded-md p-3 overflow-x-auto">
{`{
        ...
        <Card>
          <CardHeader>
            <div>
              ...
              <CardDescription>Surrounding events.</CardDescription>
            </div>
          </CardHeader>
          <CardContent>
            <Timeline
