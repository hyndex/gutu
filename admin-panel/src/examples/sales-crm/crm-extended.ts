...
export const opportunityListView = defineListView({
  ...
  columns: [
    ...
    { field: "amount", label: "Amount", align: "right", sortable: true, kind: "currency", totaling: "sum" },
    { field: "probability", label: "Prob %", align: "right", sortable: true, kind: "number", totaling: "avg" },
    { field: "weightedAmount", label: "Weighted", align: "right", sortable: true, kind: "currency", totaling: "sum" },
    {
      field: "stage",
      label: "Stage",
      kind: "enum",
...
export const campaignListView = defineListView({
  ...
  columns: [
    ...
    { field: "budget", label: "Budget", align: "right", kind: "currency", totaling: "sum" },
    { field: "spent", label: "Spent", align: "right", kind: "currency", totaling: "sum" },
    { field: "leadsGenerated", label: "Leads", align: "right", kind: "number", totaling: "sum" },
    { field: "revenueGenerated", label: "Revenue", align: "right", kind: "currency", totaling: "sum" },
...
export const contractListView = defineListView({
  ...
  columns: [
    ...
    { field: "value", label: "Value", align: "right", kind: "currency", totaling: "sum" },
    {
      field: "status",
      label: "Status",
      kind: "enum",
