...
const connectivityReport: ReportDefinition = {
...
const relationshipStrengthReport: ReportDefinition = {
...
export const PARTY_REPORTS: readonly ReportDefinition[] = [connectivityReport, relationshipStrengthReport];
