...
export const crmContactConnections: ConnectionDescriptor = {
...
export const crmOpportunityConnections: ConnectionDescriptor = {
...
export const crmCampaignConnections: ConnectionDescriptor = {
