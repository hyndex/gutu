...
export const hrPayrollPlugin = buildDomainPlugin({
  ...
  resources: [
    ...
    },
    {
      ...
      seed: (i) => ({
        name: pick(
          ["Basic", "HRA", "Transport", "Meal", "Bonus", "Tax", "PF", "Insurance", "Loan Deduction", "Overtime"],
          i,
        ),
        kind: pick(["earning", "earning", "earning", "earning", "earning", "deduction", "deduction", "deduction", "deduction", "earning"], i),
        formula: pick(
          ["base", "base * 0.15", "flat 500", "flat 200", "perf * 1000", "gross * 0.2", "gross * 0.08", "flat 150", "amount", "hours * rate"],
          i,
        ),
        taxable: i % 2 === 0,
      }),
