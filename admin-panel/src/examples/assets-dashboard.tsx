...
const depreciationScheduleReport: ReportDefinition = {
...
const assignmentsReport: ReportDefinition = {
...
const maintenanceDueReport: ReportDefinition = {
...
export const ASSETS_REPORTS: readonly ReportDefinition[] = [
