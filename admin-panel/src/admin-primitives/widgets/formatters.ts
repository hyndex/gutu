import type { NumberCardWidget } from "@/contracts/widgets";

type Format = NumberCardWidget["format"];

export function formatValue(value: number, format: Format | undefined, currency = "USD"): string {
