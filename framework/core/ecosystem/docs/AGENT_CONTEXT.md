# Ecosystem Agent Context

Package/app id: `ecosystem`
Target type: `package`  | Package kind: `framework-core`
Location: `framework/core/ecosystem`

## Purpose

Split-repo ecosystem contracts, compatibility channels, vendoring plans, and catalog generation for Gutu.
...
- _No declared capabilities._

## Requested capabilities

- _No requested capabilities._
