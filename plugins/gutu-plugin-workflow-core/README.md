...
This tier is justified because unit coverage exists, contract coverage exists, and workflow definitions are exported.
...
| Field | Value |
| --- | --- |
| Package | `@plugins/workflow-core` |
| Manifest ID | `workflow-core` |
| Repo | [gutu-plugin-workflow-core](https://github.com/gutula/gutu-plugin-workflow-core) |
...
| Provided Capabilities | `workflow.instances` |
| Runtime | bun>=1.3.12 |
...
console.log(transitionWorkflowInstanceAction.id);
console.log(WorkflowInstanceResource.id);
```

Use the root repo scripts for day-to-day work **after the workspace is bootstrapped**, or run the nested package directly from `framework/builtin-plugins/workflow-core` if you need lower-level control.
...
- `plugins/gutu-plugin-workflow-core/framework/builtin-plugins/workflow-core/docs/AGENT_CONTEXT.md`
- `plugins/gutu-plugin-workflow-core/framework/builtin-plugins/workflow-core/docs/BUSINESS_RULES.md`
- `plugins/gutu-plugin-workflow-core/framework/builtin-plugins/workflow-core/docs/EDGE_CASES.md`
- `plugins/gutu-plugin-workflow-core/framework/builtin-plugins/workflow-core/docs/FLOWS.md`
- `plugins/gutu-plugin-workflow-core/framework/builtin-plugins/workflow-core/docs/GLOSSARY.md`
- `plugins/gutu-plugin-workflow-core/framework/builtin-plugins/workflow-core/docs/MANDATORY_STEPS.md`
