...
- Package root: `framework/builtin-plugins/workflow-core`
- Service layer: `framework/builtin-plugins/workflow-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/workflow-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/workflow-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/workflow-core/src/ui`

## Safe assumptions

- Use `workflow-core` as the stable plugin identifier and `@plugins/workflow-core` as the package import name.
