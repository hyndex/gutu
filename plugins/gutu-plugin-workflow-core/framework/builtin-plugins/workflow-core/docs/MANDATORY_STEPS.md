...
2. Keep the nested docs under `framework/builtin-plugins/workflow-core/docs` synchronized with the same truth.
...
1. Depend on the manifest ID `workflow-core` and the package import `@plugins/workflow-core`.
