...
- Package root: `framework/builtin-plugins/auth-core`
- Service layer: `framework/builtin-plugins/auth-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/auth-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/auth-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/auth-core/src/ui`

## Safe assumptions

- Use `auth-core` as the stable plugin identifier and `@plugins/auth-core` as the package import name.
