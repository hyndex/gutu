...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/ai-evals");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-ai-evals:");
...
console.log("Documentation check passed for gutu-plugin-ai-evals.");
