# AI Evals Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `ai-evals` and its owned resource set.
...
- This plugin currently exports 2 action(s), 2 resource(s), 0 job definition(s), and 0 workflow definition(s).
