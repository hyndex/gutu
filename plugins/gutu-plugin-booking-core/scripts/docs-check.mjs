...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/booking-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-booking-core:");
...
console.log("Documentation check passed for gutu-plugin-booking-core.");
