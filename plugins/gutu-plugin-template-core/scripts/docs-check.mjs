...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/template-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-template-core:");
...
console.log("Documentation check passed for gutu-plugin-template-core.");
