...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/audit-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-audit-core:");
...
console.log("Documentation check passed for gutu-plugin-audit-core.");
