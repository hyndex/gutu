...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/page-builder-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-page-builder-core:");
...
console.log("Documentation check passed for gutu-plugin-page-builder-core.");
