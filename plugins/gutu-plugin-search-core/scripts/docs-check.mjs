...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/search-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-search-core:");
...
console.log("Documentation check passed for gutu-plugin-search-core.");
