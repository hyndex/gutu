...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/ai-rag");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-ai-rag:");
...
console.log("Documentation check passed for gutu-plugin-ai-rag.");
