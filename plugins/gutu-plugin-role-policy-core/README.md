...
| Field | Value |
| --- | --- |
| Package | `@plugins/role-policy-core` |
| Manifest ID | `role-policy-core` |
| Repo | [gutu-plugin-role-policy-core](https://github.com/gutula/gutu-plugin-role-policy-core) |
| Depends On | `auth-core`, `org-tenant-core` |
| Requested Capabilities | `ui.register.admin`, `api.rest.mount`, `data.write.roles` |
| Provided Capabilities | `roles.grants` |
| Runtime | bun>=1.3.12 |
...
| --- | --- | --- |
| Actions | 1 | `roles.grants.assign` |
| Resources | 1 | `roles.grants` |
...
console.log(assignGrantAction.id);
console.log(GrantResource.id);
```

Use the root repo scripts for day-to-day work **after the workspace is bootstrapped**, or run the nested package directly from `framework/builtin-plugins/role-policy-core` if you need lower-level control.
...
- `plugins/gutu-plugin-role-policy-core/framework/builtin-plugins/role-policy-core/docs/AGENT_CONTEXT.md`
- `plugins/gutu-plugin-role-policy-core/framework/builtin-plugins/role-policy-core/docs/BUSINESS_RULES.md`
- `plugins/gutu-plugin-role-policy-core/framework/builtin-plugins/role-policy-core/docs/EDGE_CASES.md`
- `plugins/gutu-plugin-role-policy-core/framework/builtin-plugins/role-policy-core/docs/FLOWS.md`
- `plugins/gutu-plugin-role-policy-core/framework/builtin-plugins/role-policy-core/docs/GLOSSARY.md`
- `plugins/gutu-plugin-role-policy-core/framework/builtin-plugins/role-policy-core/docs/MANDATORY_STEPS.md`
