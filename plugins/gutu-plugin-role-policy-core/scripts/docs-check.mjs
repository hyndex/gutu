...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/role-policy-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-role-policy-core:");
...
console.log("Documentation check passed for gutu-plugin-role-policy-core.");
