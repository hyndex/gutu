...
- Package root: `framework/builtin-plugins/knowledge-core`
- Service layer: `framework/builtin-plugins/knowledge-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/knowledge-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/knowledge-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/knowledge-core/src/ui`

## Safe assumptions

- Use `knowledge-core` as the stable plugin identifier and `@plugins/knowledge-core` as the package import name.
