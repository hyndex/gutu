...
| Field | Value |
| --- | --- |
| Package | `@plugins/knowledge-core` |
| Manifest ID | `knowledge-core` |
| Repo | [gutu-plugin-knowledge-core](https://github.com/gutula/gutu-plugin-knowledge-core) |
...
| Provided Capabilities | `knowledge.articles` |
| Runtime | bun>=1.3.12 |
...
| --- | --- | --- |
| Actions | 1 | `knowledge.articles.publish` |
| Resources | 1 | `knowledge.articles` |
...
console.log(publishKnowledgeArticleAction.id);
console.log(KnowledgeArticleResource.id);
```

Use the root repo scripts for day-to-day work **after the workspace is bootstrapped**, or run the nested package directly from `framework/builtin-plugins/knowledge-core` if you need lower-level control.
...
- `plugins/gutu-plugin-knowledge-core/framework/builtin-plugins/knowledge-core/docs/AGENT_CONTEXT.md`
- `plugins/gutu-plugin-knowledge-core/framework/builtin-plugins/knowledge-core/docs/BUSINESS_RULES.md`
- `plugins/gutu-plugin-knowledge-core/framework/builtin-plugins/knowledge-core/docs/EDGE_CASES.md`
- `plugins/gutu-plugin-knowledge-core/framework/builtin-plugins/knowledge-core/docs/FLOWS.md`
- `plugins/gutu-plugin-knowledge-core/framework/builtin-plugins/knowledge-core/docs/GLOSSARY.md`
- `plugins/gutu-plugin-knowledge-core/framework/builtin-plugins/knowledge-core/docs/MANDATORY_STEPS.md`
