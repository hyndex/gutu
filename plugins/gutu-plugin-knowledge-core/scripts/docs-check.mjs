...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/knowledge-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-knowledge-core:");
...
console.log("Documentation check passed for gutu-plugin-knowledge-core.");
