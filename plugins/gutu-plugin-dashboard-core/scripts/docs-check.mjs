...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/dashboard-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-dashboard-core:");
...
console.log("Documentation check passed for gutu-plugin-dashboard-core.");
