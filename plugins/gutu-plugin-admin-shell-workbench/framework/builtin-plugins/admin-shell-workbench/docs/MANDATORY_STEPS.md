# Admin Shell Workbench Mandatory Steps

## Before shipping a change

1. Update the public contract docs in `README.md` and `DEVELOPER.md`.
2. Keep the nested docs under `framework/builtin-plugins/admin-shell-workbench/docs` synchronized with the same truth.
...
1. Depend on the manifest ID `admin-shell-workbench` and the package import `@plugins/admin-shell-workbench`.
