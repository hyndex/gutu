# Admin Shell Workbench Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `admin-shell-workbench` and its owned resource set.
...
- This plugin currently exports 0 action(s), 0 resource(s), 0 job definition(s), and 0 workflow definition(s).
