...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/admin-shell-workbench");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-admin-shell-workbench:");
...
console.log("Documentation check passed for gutu-plugin-admin-shell-workbench.");
