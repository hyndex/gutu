...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/community-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-community-core:");
...
console.log("Documentation check passed for gutu-plugin-community-core.");
