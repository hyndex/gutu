...
| Field | Value |
| --- | --- |
| Package | `@plugins/org-tenant-core` |
| Manifest ID | `org-tenant-core` |
| Repo | [gutu-plugin-org-tenant-core](https://github.com/gutula/gutu-plugin-org-tenant-core) |
| Depends On | `auth-core` |
| Requested Capabilities | `ui.register.admin`, `api.rest.mount`, `data.write.org` |
| Provided Capabilities | `org.tenants` |
| Runtime | bun>=1.3.12 |
...
| --- | --- | --- |
| Actions | 1 | `org.tenants.activate` |
| Resources | 1 | `org.tenants` |
...
console.log(activateTenantAction.id);
console.log(TenantResource.id);
```

Use the root repo scripts for day-to-day work **after the workspace is bootstrapped**, or run the nested package directly from `framework/builtin-plugins/org-tenant-core` if you need lower-level control.
...
- `plugins/gutu-plugin-org-tenant-core/framework/builtin-plugins/org-tenant-core/docs/AGENT_CONTEXT.md`
- `plugins/gutu-plugin-org-tenant-core/framework/builtin-plugins/org-tenant-core/docs/BUSINESS_RULES.md`
- `plugins/gutu-plugin-org-tenant-core/framework/builtin-plugins/org-tenant-core/docs/EDGE_CASES.md`
- `plugins/gutu-plugin-org-tenant-core/framework/builtin-plugins/org-tenant-core/docs/FLOWS.md`
- `plugins/gutu-plugin-org-tenant-core/framework/builtin-plugins/org-tenant-core/docs/GLOSSARY.md`
- `plugins/gutu-plugin-org-tenant-core/framework/builtin-plugins/org-tenant-core/docs/MANDATORY_STEPS.md`
