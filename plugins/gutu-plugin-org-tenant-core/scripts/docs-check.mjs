...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/org-tenant-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-org-tenant-core:");
...
console.log("Documentation check passed for gutu-plugin-org-tenant-core.");
