...
- Package root: `framework/builtin-plugins/org-tenant-core`
- Service layer: `framework/builtin-plugins/org-tenant-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/org-tenant-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/org-tenant-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/org-tenant-core/src/ui`

## Safe assumptions

- Use `org-tenant-core` as the stable plugin identifier and `@plugins/org-tenant-core` as the package import name.
