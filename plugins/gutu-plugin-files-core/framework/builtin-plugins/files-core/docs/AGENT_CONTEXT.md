...
- Package root: `framework/builtin-plugins/files-core`
- Service layer: `framework/builtin-plugins/files-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/files-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/files-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/files-core/src/ui`

## Safe assumptions

- Use `files-core` as the stable plugin identifier and `@plugins/files-core` as the package import name.
