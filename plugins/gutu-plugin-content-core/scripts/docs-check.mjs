...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/content-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-content-core:");
...
console.log("Documentation check passed for gutu-plugin-content-core.");
