...
| Field | Value |
| --- | --- |
| Package | `@plugins/content-core` |
| Manifest ID | `content-core` |
| Repo | [gutu-plugin-content-core](https://github.com/gutula/gutu-plugin-content-core) |
...
| Provided Capabilities | `content.entries` |
| Runtime | bun>=1.3.12 |
...
| --- | --- | --- |
| Actions | 1 | `content.entries.publish` |
| Resources | 1 | `content.entries` |
...
console.log(publishContentEntryAction.id);
console.log(ContentEntryResource.id);
```

Use the root repo scripts for day-to-day work **after the workspace is bootstrapped**, or run the nested package directly from `framework/builtin-plugins/content-core` if you need lower-level control.
...
- `plugins/gutu-plugin-content-core/framework/builtin-plugins/content-core/docs/AGENT_CONTEXT.md`
- `plugins/gutu-plugin-content-core/framework/builtin-plugins/content-core/docs/BUSINESS_RULES.md`
- `plugins/gutu-plugin-content-core/framework/builtin-plugins/content-core/docs/EDGE_CASES.md`
- `plugins/gutu-plugin-content-core/framework/builtin-plugins/content-core/docs/FLOWS.md`
- `plugins/gutu-plugin-content-core/framework/builtin-plugins/content-core/docs/GLOSSARY.md`
- `plugins/gutu-plugin-content-core/framework/builtin-plugins/content-core/docs/MANDATORY_STEPS.md`
