...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/portal-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-portal-core:");
...
console.log("Documentation check passed for gutu-plugin-portal-core.");
