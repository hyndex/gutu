...
| Field | Value |
| --- | --- |
| Package | `@plugins/portal-core` |
| Manifest ID | `portal-core` |
| Repo | [gutu-plugin-portal-core](https://github.com/gutula/gutu-plugin-portal-core) |
...
| Provided Capabilities | `portal.accounts` |
| Runtime | bun>=1.3.12 |
...
| --- | --- | --- |
| Actions | 1 | `portal.accounts.enable` |
| Resources | 1 | `portal.accounts` |
...
console.log(enablePortalAccountAction.id);
console.log(PortalAccountResource.id);
```

Use the root repo scripts for day-to-day work **after the workspace is bootstrapped**, or run the nested package directly from `framework/builtin-plugins/portal-core` if you need lower-level control.
...
- `plugins/gutu-plugin-portal-core/framework/builtin-plugins/portal-core/docs/AGENT_CONTEXT.md`
- `plugins/gutu-plugin-portal-core/framework/builtin-plugins/portal-core/docs/BUSINESS_RULES.md`
- `plugins/gutu-plugin-portal-core/framework/builtin-plugins/portal-core/docs/EDGE_CASES.md`
- `plugins/gutu-plugin-portal-core/framework/builtin-plugins/portal-core/docs/FLOWS.md`
- `plugins/gutu-plugin-portal-core/framework/builtin-plugins/portal-core/docs/GLOSSARY.md`
- `plugins/gutu-plugin-portal-core/framework/builtin-plugins/portal-core/docs/MANDATORY_STEPS.md`
