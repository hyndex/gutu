...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/ai-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-ai-core:");
...
console.log("Documentation check passed for gutu-plugin-ai-core.");
