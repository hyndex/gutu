...
2. Keep the nested docs under `framework/builtin-plugins/ai-core/docs` synchronized with the same truth.
...
1. Depend on the manifest ID `ai-core` and the package import `@plugins/ai-core`.
