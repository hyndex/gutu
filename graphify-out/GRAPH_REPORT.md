...
## Corpus Check
- 4169 files · ~6,914,813 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9590 nodes · 14816 edges · 80 communities detected
- Extraction: 69% EXTRACTED · 31% INFERRED · 0% AMBIGUOUS · INFERRED: 4570 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (547): accessibleRecordIds(), effectiveRole(), grantAcl(), listAcl(), purgeAclForRecord(), revokeAcl(), roleAtLeast(), roleFromLinkToken() (+539 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (246): canLaunchZone(), canRunAction(), canSeeField(), canSeeWidget(), canUseBuilder(), canUseCommand(), canViewPage(), canViewReport() (+238 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (294): cloneAccount(), cloneEntry(), clonePeriod(), createErpAccountingRuntime(), daysBetween(), defaultNormalBalance(), defineErpAccount(), signedAmount() (+286 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (194): AdminInner(), AdminRoot(), PermissionsRoot(), PlaygroundUI(), AIInsightPanel(), AppShell(), buildCrumbs(), ExternalViewRenderer() (+186 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (213): runOrError(), safeJson(), asRecord(), bodyJson(), findExplore(), getTyped(), localWarehouseAdapter(), messageOf() (+205 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (194): fmtCurrency(), mockKpis(), mockSeries(), fmtCurrency(), mockKpis(), mockSeries(), AiEvalsRunDetailPage(), ExecutiveDashboard() (+186 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (197): aggregate(), bucketKey(), computeAggregation(), evalFilter(), evalLeaf(), previousRange(), resolveTimeRange(), apiBase() (+189 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (139): decodeEncodedWords(), formatAddress(), isValidEmail(), normalizeEmail(), normalizeSubject(), parseAddress(), parseAddressList(), participantsHash() (+131 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (111): AdvancedDataTable(), loadState(), AlertCenter(), intentClass(), AvatarGroup(), BarChart(), Breadcrumbs(), buildMonthGrid() (+103 more)
...
Cohesion: 0.02
Nodes (116): applyEncryption(), bufferUpTo(), concat(), existsFile(), fromS3StorageClass(), LocalStorageAdapter, nodeToWebStream(), renderPrefix() (+108 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (128): isRecord(), normalizeEvent(), sanitizeJson(), asSeries(), countBadges(), parse(), assertRepositoryBoundary(), canUseFrameworkSymlink() (+120 more)
...
Cohesion: 0.02
Nodes (110): bankAccounts(), bankTransactions(), budgets(), code(), costCenters(), count(), currencyRates(), dunning() (+102 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (84): handleApply(), compileBiQuery(), createBiChart(), createBiDashboard(), createBiSchedule(), createBiShare(), createBiSpace(), drillDownBiQuery() (+76 more)
...
Cohesion: 0.04
Nodes (62): bootstrapStorage(), localDefaultConfig(), parseStorageBackendsEnv(), s3DefaultFromEnv(), close(), dispatchForRead(), dispatchForWrite(), api() (+54 more)
...
Cohesion: 0.04
Nodes (48): writeRootPackageJson(), countConditionKeys(), backoffMs(), collectParticipants(), collectParticipantsFromMessages(), fetchJson(), fetchWithTimeout(), jmapAddrToAddress() (+40 more)
...
Cohesion: 0.05
Nodes (15): logout(), asAttachment(), ImageDetail(), onKey(), ImapClient, ImapError, parseIdleLine(), tokenize() (+7 more)
...
Cohesion: 0.04
Nodes (47): addLeaf(), AdvancedFilterBuilder(), emit(), emptyLeaf(), isLeaf(), removeAt(), toGroup(), updateAt() (+39 more)
...
Cohesion: 0.07
Nodes (20): CustomFieldsBlock(), humanize(), isFieldVisible(), SectionFields(), validateForm(), FrameEditor(), handler(), postToParent() (+12 more)
...
Cohesion: 0.15
Nodes (31): assertAuditHealthy(), assertCertificationHealthy(), assertConsumerSmokeHealthy(), copyCoreRoot(), copyRepoRoots(), createAuditReport(), discoverCorePackageIds(), discoverPackages() (+23 more)
...
Cohesion: 0.22
Nodes (16): withLeadership(), cronMatches(), ensureRunsTable(), fieldMatches(), fireOnce(), getScheduleRunsForTest(), listTimeBasedRules(), recordsWithDateField() (+8 more)
...
- **Why does `String()` connect `Community 6` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 26`, `Community 28`, `Community 29`, `Community 32`, `Community 34`, `Community 35`, `Community 37`, `Community 39`, `Community 46`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `replace()` connect `Community 7` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 39`, `Community 44`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `parse()` connect `Community 11` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 28`, `Community 29`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 37`, `Community 45`?**
...
- **Are the 168 inferred relationships involving `parse()` (e.g. with `readGutuPlugins()` and `migrate()`) actually correct?**
  _`parse()` has 168 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 124 inferred relationships involving `set()` (e.g. with `authedFetch()` and `authedFetch()`) actually correct?**
  _`set()` has 124 INFERRED edges - model-reasoned connections that need verification._