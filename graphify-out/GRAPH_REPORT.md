...
## Corpus Check
- 4127 files · ~6,882,492 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9395 nodes · 14233 edges · 78 communities detected
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 4196 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (512): accessibleRecordIds(), effectiveRole(), grantAcl(), listAcl(), purgeAclForRecord(), revokeAcl(), roleAtLeast(), roleFromLinkToken() (+504 more)
...
Cohesion: 0.01
Nodes (201): AdminInner(), AdminRoot(), PermissionsRoot(), PlaygroundUI(), AIInsightPanel(), AppShell(), buildCrumbs(), ExternalViewRenderer() (+193 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (178): renderPrefix(), decodeEncodedWords(), formatAddress(), formatAddresses(), isValidEmail(), normalizeEmail(), normalizeSubject(), parseAddress() (+170 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (206): createActivationEngine(), runOrError(), safeJson(), apiBase(), createEditorRecord(), createPublicLink(), deleteEditorRecord(), fetchEditorRecord() (+198 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (165): fmtCurrency(), mockKpis(), mockSeries(), fmtCurrency(), mockKpis(), mockSeries(), AiEvalsRunDetailPage(), ExecutiveDashboard() (+157 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (157): isRecord(), normalizeEvent(), sanitizeJson(), applyMapping(), ensureJobsTable(), listImportJobs(), parseJsonOrJsonl(), countBadges() (+149 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (183): apiBase(), authHeaders(), autoMap(), commit(), onFile(), onPaste(), runDryRun(), runContractScenario() (+175 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (149): fetchAll(), monthKey(), num(), str(), aggregate(), bucketKey(), computeAggregation(), evalFilter() (+141 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (111): AdvancedDataTable(), loadState(), addLeaf(), AdvancedFilterBuilder(), emit(), emptyLeaf(), isLeaf(), removeAt() (+103 more)
...
Cohesion: 0.02
Nodes (104): applyEncryption(), bufferUpTo(), concat(), existsFile(), fromS3StorageClass(), LocalStorageAdapter, nodeToWebStream(), S3StorageAdapter (+96 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (137): canLaunchZone(), canRunAction(), canSeeField(), canSeeWidget(), canUseBuilder(), canUseCommand(), canViewPage(), canViewReport() (+129 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (82): toSnakeCase(), toggleAll(), toggleRow(), operatorsFor(), closeComposer(), dropUndo(), emit(), getMailState() (+74 more)
...
Cohesion: 0.03
Nodes (134): normaliseDate(), checkCatalog(), checkPluginDocs(), main(), missingHeadings(), placeholderFailures(), buildImportList(), capitalize() (+126 more)
...
Cohesion: 0.03
Nodes (71): compileBiQuery(), createBiChart(), createBiDashboard(), createBiSchedule(), createBiShare(), createBiSpace(), drillDownBiQuery(), fetchBiCatalog() (+63 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (92): close(), closeDbx(), resetRoomManager(), RoomManager, trigger(), openPrintableDocument(), main(), runScenario() (+84 more)
...
Cohesion: 0.04
Nodes (91): api(), login(), main(), record(), safe(), scenarioAuthGuards(), scenarioCrudEdges(), scenarioDiscovery() (+83 more)
...
Cohesion: 0.04
Nodes (43): buildViews(), buildCompactControlRoom(), buildControlRoom(), formViewFromZod(), humanize(), inferField(), unwrap(), zodKind() (+35 more)
...
Cohesion: 0.04
Nodes (31): handleApply(), handler(), setLink(), BlockSuitePageAdapter, loadBlockSuite(), BlockSuiteEdgelessAdapter, loadBlockSuite(), FrameEditor() (+23 more)
...
Cohesion: 0.04
Nodes (31): bootstrapStorage(), localDefaultConfig(), parseStorageBackendsEnv(), s3DefaultFromEnv(), dispatchForRead(), dispatchForWrite(), capStream(), errorToResponse() (+23 more)
...
Cohesion: 0.06
Nodes (26): Toolbar(), ToolbarButton(), createRuntime(), cryptoId(), RuntimeProvider(), CapabilityRegistryImpl, createCapabilityRegistry(), createFeatureFlags() (+18 more)
...
Cohesion: 0.17
Nodes (9): EChartsCard(), themeOption(), useCssVar(), getDensity(), getTheme(), setDensity(), setTheme(), toggleTheme() (+1 more)
...
- **Thin community `Community 24`** (101 nodes): `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mappers.ts`, `mapProviderStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 76`** (3 nodes): `storage.ts`, `isSecretKey()`, `scrubConfig()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (3 nodes): `SpacerWidget.js`, `SpacerWidget.tsx`, `SpacerWidget()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (3 nodes): `erp-metadata.js`, `erp-metadata.ts`, `defineErpResourceMetadata()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (3 nodes): `field-service-pages.js`, `field-service-pages.tsx`, `fieldServiceEvents()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (3 nodes): `hr-payroll-archetype.tsx`, `mockKpis()`, `mockSeries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 87`** (3 nodes): `cn.js`, `cn.ts`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (3 nodes): `BulkActionBar.tsx`, `execute()`, `run()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `String()` connect `Community 7` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 27`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 38`, `Community 42`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `replace()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 18`, `Community 20`, `Community 23`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 32`, `Community 34`, `Community 36`, `Community 37`, `Community 38`, `Community 42`, `Community 44`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `parse()` connect `Community 6` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 27`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 42`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Are the 238 inferred relationships involving `String()` (e.g. with `setup()` and `code()`) actually correct?**
  _`String()` has 238 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 194 inferred relationships involving `replace()` (e.g. with `personEmail()` and `personEmail()`) actually correct?**
  _`replace()` has 194 INFERRED edges - model-reasoned connections that need verification._
