...
- `plugins/gutu-plugin-booking-core`
...
- `libraries/gutu-lib-admin-builders`
- `libraries/gutu-lib-admin-contracts`
- `libraries/gutu-lib-admin-formview`
- `libraries/gutu-lib-admin-listview`
- `libraries/gutu-lib-admin-reporting`
- `libraries/gutu-lib-admin-shell-workbench`
- `libraries/gutu-lib-admin-widgets`
- `libraries/gutu-lib-ai`
- `libraries/gutu-lib-ai-evals`
- `libraries/gutu-lib-ai-guardrails`
- `libraries/gutu-lib-ai-mcp`
- `libraries/gutu-lib-ai-memory`
- `libraries/gutu-lib-ai-runtime`
- `libraries/gutu-lib-analytics`
- `libraries/gutu-lib-chart`
- `libraries/gutu-lib-command-palette`
- `libraries/gutu-lib-communication`
- `libraries/gutu-lib-contracts`
- `libraries/gutu-lib-data-table`
- `libraries/gutu-lib-editor`
- `libraries/gutu-lib-email-templates`
...
- `libraries/gutu-lib-ui-form`
- `libraries/gutu-lib-ui-kit`
- `libraries/gutu-lib-ui-query`
- `libraries/gutu-lib-ui-router`
- `libraries/gutu-lib-ui-shell`
- `libraries/gutu-lib-ui-table`
- `libraries/gutu-lib-ui-zone-next`
- `libraries/gutu-lib-ui-zone-static`

## Apps

- `apps/gutu-app-docs`
- `apps/gutu-app-examples`
- `apps/gutu-app-platform-dev-console`
- `apps/gutu-app-playground`
